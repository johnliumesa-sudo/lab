...
#+begin_src lua
  ...
  eventFolder.Name = "EventFolder123"
...
***** TypingClient
:properties:
:header-args:lua: :tangle ./place2/src/server/UI/TypingClient.client.luau
:END:
******* notes
...
#+begin_src lua
  ...
  local WordEvent = game:GetService("ReplicatedStorage"):WaitForChild("WordEvent")
