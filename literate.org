...
#+begin_src lua
  ...
  tb.Position = UDim2.new(0, 0, 0.1, 0)
  ...
  timerFrame.Position = UDim2.new(0, 750,0, 10)
  timerFrame.Size = UDim2.new(0, 150,0, 60)
  timerFrame.BorderSizePixel = 5
  timerFrame.Parent = sg
  local timer = Instance.new("TextLabel")
  timer.Position = UDim2.new(0, 770,0, 10)
  timerFrame.Size = UDim2.new(0, 108,0, 42)
  timer.Font = Enum.Font.Arimo
  timer.FontFace.Bold = true
  timer.Parent = timerFrame
  local time = 0
  timer.Text = time
  local uic3 = uic2:Clone()
  uic3.Parent = timerFrame
  local uic4 = uic3:Clone()
  uic4.Parent = timer
  local stats = {}
  local wt = 0
#+end_src
...
local function timer()
	local wpm = wt/60
	local statsTable = table.insert(stats, {WPM = wpm, WT = wt})
	while true do 
		if time < 60 then
			timer.text = time + 1
			task.wait(1)
...
#+begin_src lua
  ...
  frontWall.Size = Vector3.new(48,48,2)
