...
****** PresentManager
:properties:
:header-args:lua: :tangle ./place5/src/server/Collectables/PresentManager.server.luau
:END:
******* notes
Spawns the coins into the world.
******* code
...
****** PresentScript
:properties:
:header-args:lua: :tangle ./place5/src/server/Collectables/PresentScript.server.luau
:END:
******* notes
Defines individual coin behavior (rotate, touch, reward).
******* code
...
***** BlockManager
:properties:
:header-args:lua: :tangle ./place5/src/server/obstacles/BlockManager.server.luau
:END:
****** notes
Generates and manages random blocks as obstacles in an orientation that allows the player to escape from patrols, however, it allows attackers to climb. 
****** code
...
****** PortalManager
:properties:
:header-args:lua: :tangle ./place5/src/server/Establishments/PortalManager.server.luau
:END:
******* notes
Spawns the coins into the world.
******* code
...
****** PortalScript
:properties:
:header-args:lua: :tangle ./place5/src/server/Establishments/PortalScript.server.luau
:END:
******* notes
Defines internal behavior of toolstands.
******* code
...
****** AppleManager
:properties:
:header-args:lua: :tangle ./place5/src/server/Tools/AppleManager.server.luau
:END:
******* notes
Spawns speed coils into the world.
******* code
...
****** AppleScript
:properties:
:header-args:lua: :tangle ./place5/src/server/Tools/AppleScript.server.luau
:END:
******* notes
Defines individual speed coil behavior. Handle is a mesh part but it has to have the name "Handle" for it to have the TouchInterest, to support the onEquipped event.
******* code
...
****** GravityCoilManager
:properties:
:header-args:lua: :tangle ./place5/src/server/Tools/GravityCoilManager.server.luau
:END:
******* notes
Spawns gravity coils into the world.
******* code
...
****** GravityCoilScript
:properties:
:header-args:lua: :tangle ./place5/src/server/Tools/GravityCoilScript.server.luau
:END:
******* notes
Defines individual gravity coil behavior. Handle is a mesh part but it has to have the name "Handle" for it to have the TouchInterest, to support the onEquipped event.
******* code
...
****** CloakManager
:properties:
:header-args:lua: :tangle ./place5/src/server/Tools/CloakManager.server.luau
:END:
******* notes
Spawns gravity coils into the world.
******* code
...
****** CloakScript
:properties:
:header-args:lua: :tangle ./place5/src/server/Tools/CloakScript.server.luau
:END:
******* notes
Defines individual gravity coil behavior. Handle is a mesh part but it has to have the name "Handle" for it to have the TouchInterest, to support the onEquipped event.
******* code
...
>>>>>>> parent of 3215c5c (created Cloaks. (#40))
:properties:
:header-args:lua: :tangle ./place5/src/server/Tools/SpeedCoilManager.server.luau
:END:
******* notes
Spawns speed coils into the world.
******* code
...
****** SpeedCoilScript
:properties:
:header-args:lua: :tangle ./place5/src/server/Tools/SpeedCoilScript.server.luau
:END:
******* notes
Defines individual speed coil behavior. Handle is a mesh part but it has to have the name "Handle" for it to have the TouchInterest, to support the onEquipped event.
******* code
...
****** SwordManager
:properties:
:header-args:lua: :tangle ./place5/src/server/Tools/SwordManager.server.luau
:END:
******* notes
Spawns speed coils into the world.
******* code
...
****** SwordScript
:properties:
:header-args:lua: :tangle ./place5/src/server/Tools/SwordScript.server.luau
:END:
******* notes
Defines individual speed coil behavior. Handle is a mesh part but it has to have the name "Handle" for it to have the TouchInterest, to support the onEquipped event.
******* code
...
****** ToolSpawnerScript
:properties:
:header-args:lua: :tangle ./place5/src/server/Tools/ToolSpawnerScript.server.luau
:END:
******* notes
Defines internal behavior of toolstands.
******* code
