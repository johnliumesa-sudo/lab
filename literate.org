...
#+begin_src lua
  local ReplicatedStorage = game:GetService("ReplicatedStorage")
  local Workspace = game:GetService("Workspace")
  local proximityScript = script.Parent:FindFirstChild("ProximityPlotScript")
...
********* spawnGrid
#+begin_src lua
  local function spawnGrid(proximityScript)
      for x = 1, gridSize do
  	for z = 1, gridSize do
  	    ...
  	    -- Inject logic script
  	    if proximityScript then
  		local proximScriptClone = proximityScript:Clone()
  		proximScriptClone.Parent= newPlot
  		proximScriptClone.Enabled = true
  	    end
  	end
      end
  end
...
:END:
******* notes
This script replaces the click detector logic with a ProximityPrompt. It creates the prompt dynamically on the plot and handles the interaction for planting.
******* code
******** guards
#+begin_src lua 
