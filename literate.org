...
***** PresentManager
:properties:
:header-args:lua: :tangle ./src/server/Collectables/PresentManager.server.luau
:END:
****** notes
Spawns the coins into the world.
****** code
...
***** PresentScript
:properties:
:header-args:lua: :tangle ./src/server/Collectables/PresentScript.server.luau
:END:
****** notes
Defines individual coin behavior (rotate, touch, reward).
****** code
...
:properties:
:header-args:lua: :tangle ./src/server/Establishments/TerrainModifierScript.server.luau
:END:
****** notes
...
***** PortalManager
:properties:
:header-args:lua: :tangle ./src/server/Establishments/PortalManager.server.luau
:END:
****** notes
Spawns the coins into the world.
****** code
******* variables
#+begin_src lua
  local portal = game:GetService("ReplicatedStorage"):FindFirstChild("Establishments"):FindFirstChild("Portals"):FindFirstChild("Part")
...
***** PortalScript
:properties:
:header-args:lua: :tangle ./src/server/Establishments/PortalScript.server.luau
:END:
****** notes
Defines internal behavior of toolstands.
****** code
...
:properties:
:header-args:lua: :tangle ./src/server/Establishments/ChristmasTreeManager.server.luau
:END:
****** notes
Spawns the coins into the world.
****** code
******* variables
#+begin_src lua
  local christmastree = game:GetService("ReplicatedStorage"):FindFirstChild("Establishments"):FindFirstChild("ChristmasTrees"):FindFirstChild("Part")
...
***** ChristmasTreeScript
:properties:
:header-args:lua: :tangle ./src/server/Establishments/ChristmasTreeScript.server.luau
:END:
****** notes
Defines internal behavior of toolstands.
****** code
...
***** AppleManager
:properties:
:header-args:lua: :tangle ./src/server/Tools/AppleManager.server.luau
:END:
****** notes
...
***** AppleScript
:properties:
:header-args:lua: :tangle ./src/server/Tools/AppleScript.server.luau
:END:
****** notes
...
***** SpeedCoilManager
:properties:
:header-args:lua: :tangle ./src/server/Tools/SpeedCoilManager.server.luau
:END:
****** notes
Spawns speed coils into the world.
****** code
...
***** SpeedCoilScript
:properties:
:header-args:lua: :tangle ./src/server/Tools/SpeedCoilScript.server.luau
:END:
****** notes
Defines individual speed coil behavior. Handle is a mesh part but it has to have the name "Handle" for it to have the TouchInterest, to support the onEquipped event.
****** code
...
***** SwordManager
:properties:
:header-args:lua: :tangle ./src/server/Tools/SwordManager.server.luau
:END:
****** notes
Spawns speed coils into the world.
****** code
...
***** SwordScript
:properties:
:header-args:lua: :tangle ./src/server/Tools/SwordScript.server.luau
:END:
****** notes
Defines individual speed coil behavior. Handle is a mesh part but it has to have the name "Handle" for it to have the TouchInterest, to support the onEquipped event.
****** code
