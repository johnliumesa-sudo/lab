...
:END:
***** notes
The logic where players interact with clerks/tool shops using dialog via remote events
***** code
****** variables
#+begin_src lua
    local Players = game:GetService("Players")
...
** tool shop manager
#+begin_src lua
  local toolShop = game:GetService("ReplicatedStorage"):FindFirstChild("Establishments"):FindFirstChild("ToolShop")
  local dialogChoiceEvent = Instance.new("RemoteEvent")
  dialogChoiceEvent.Name = "DialogChoiceEvent"
  dialogChoiceEvent.Parent = toolShop

  local tradingEvent = Instance.new("RemoteEvent")
  tradingEvent.Name = "TradingEvent"
  tradingEvent.Parent = toolShop

  local displayItemsEvent = Instance.new("RemoteEvent")
  displayItemsEvent.Name = "DisplayItemsEvent"
  displayItemsEvent.Parent = toolShop

  local feedbackMessageEvent = Instance.new("RemoteEvent")
  feedbackMessageEvent.Name = "FeedbackMessageEvent"
  feedbackMessageEvent.Parent = toolShop

  -- local PlayerFinderEvent = Instance.new("RemoteEvent")
  -- PlayerFinderEvent.Name = "PlayerFinderEvent"
  -- PlayerFinderEvent.Parent = toolShop 

  -- local WireTransferEvent = Instance.new("RemoteEvent")
  -- WireTransferEvent.Name = "WireTransferEvent"
  -- WireTransferEvent.Parent = toolShop

  -- local MoneyReciverEvent = Instance.new("RemoteEvent")
  -- MoneyReciverEvent.Name = "MoneyReciverEvent"
  -- MoneyReciverEvent.Parent = toolShop

  -- local npc = workspace.Store:WaitForChild("NPC")
  -- local dialog = npc:WaitForChild("Head"):WaitForChild("Dialog")
  -- local serverStorage = game:GetService("ServerStorage")
  local itemsFolder = workspace:WaitForChild("Tools")
  -- local toolShop = game:GetService("toolShop")
  -- local dialogChoiceEvent = toolShop:WaitForChild("DialogChoiceEvent")
  -- local tradingEvent = toolShop:WaitForChild("TradingEvent")
  -- local displayItemsEvent = toolShop:WaitForChild("DisplayItemsEvent")
  -- local feedbackMessageEvent = toolShop:WaitForChild("FeedbackMessageEvent")
  local depreciationRate = 0.5
...
local function createDialog()
    if script.Parent.Parent == game:GetService("Workspace"):FindFirstChild("NPCs") :FindFirstChild("Clerks") then 
        ...
        return sellChoice,buyChoice,npc
    end
end

local function sellChoiceConnected(buyChoice,sellChoice)
    choice = "sell"
end

local function buyChoiceConnected(buyChoice,sellChoice)
    choice = "Buy"
end

local sellChoice,buyChoice,npc = createDialog()
sellChoice.DialogChoiceSelected:Connect(sellChoiceConnected)
buyChoice.DialogChoiceSelected:Connect(buyChoiceConnected)
print(Player"chose"..choice"from"..npc.Name)
