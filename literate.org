...
:END:
******* notes
Modified to use a list of 100 holiday words. Implemented a "glow" effect using TweenService that pulsates each label's transparency and scale.
******* code
******** variables
#+begin_src lua
