...
#+begin_src lua
      ...
      local spawnRange = 48
      local presentCount = 6
      local holidayWords = {"Merry", "Jolly", "Peace", "Giving", "Cheer", "Bright", "Spirit", "Holiday"}
#+end_src
******** functions
********* createHolidayLabel
#+begin_src lua
  local function createHolidayLabel(parentPart)
     ...
     label.TextSize = 24
     -- Pick a random word
     label.Text = holidayWords[math.random(1, #holidayWords)]
...
#+begin_src lua
  ...
  frontWall.Size = Vector3.new(10,10,2)
  frontWall.Position = Vector3.new(0,5,20)
