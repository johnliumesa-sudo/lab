...
:END:
******* notes
Generates the initial grid of farmable land plots.
******* code
******** variables
#+begin_src lua
  local ReplicatedStorage = game:GetService("ReplicatedStorage")
  ...
  plotFloor.Size = Vector3.new(9, 0.5, 9)
  plotFloor.Anchored = true
  plotFloor.Material = Enum.Material.Ground
  plotFloor.Color = Color3.fromRGB(61,40,3)
...
#+begin_src lua
  ...
  plotFloor.Position = startPos + Vector3.new((x - 1) * spacing, 0, (z - 1) * spacing)
  plotFloor.Parent = newPlot
...
****** PlotScript
:properties:
:header-args:lua: :tangle ./place6/src/server/Farming/PlotScript.server.luau
:END:
******* notes
Handles the lifecycle of a single crop on a plot: Plant -> Grow -> Auto-Sell.
******* code
******** variables
#+begin_src lua
...
**** RemoteEvents
:properties:
:header-args:lua: :tangle ./place6/src/shared/Events/RemoteEventManager.server.luau
:END:
****** notes
Modified to use a list of 100  words. Implemented a "glow" effect using TweenService that pulsates each label's transparency and scale.
****** code
...
****** BottomBarScript
:properties:
:header-args:lua: :tangle ./place6/src/client/UI/BottomBarScript.client.luau
:END:
******* notes
Creates a ScreenGui with a container at the bottom of the screen holding three buttons: A, B, and C.
******* code
******** variables
#+begin_src lua
local Players = game:GetService("Players")
...
screenGui.Name = "BottomButtonsUI"
screenGui.Parent = playerGui
screenGui.ResetOnSpawn = false

-- 2. Create a Container Frame (Centered at the bottom)
local container = Instance.new("Frame")
container.Name = "Container"
container.Size = UDim2.new(1, 0, 0.15, 0) -- Takes up bottom 15% of screen
container.Position = UDim2.new(0, 0, 0.85, 0)
container.BackgroundTransparency = 1 -- Invisible container
container.Parent = screenGui

-- 3. Add Layout (Horizontal List)
local layout = Instance.new("UIListLayout")
layout.Parent = container
layout.FillDirection = Enum.FillDirection.Horizontal
layout.HorizontalAlignment = Enum.HorizontalAlignment.Center
layout.VerticalAlignment = Enum.VerticalAlignment.Center
layout.Padding = UDim.new(0, 20) -- Space between buttons

-- 4. Create Buttons A, B, and C
local buttonLabels = {"Tomato", "Corn", "Blueberry"}
...
**** default.project
:properties:
:header-args:json: :tangle ./place6/default.project.json
:END:
***** code
#+begin_src json
{
"name": "place6_farm_clicker",
"tree": {
"$className": "DataModel",
"ReplicatedStorage": {
"$path": "src/Shared"
